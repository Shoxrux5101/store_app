...
class ProductBloc extends Bloc<ProductEvent, ProductState> {
  ...
  Future<void> _onGetAllProducts(GetAllProductsEvent event, Emitter<ProductState> emit) async {
    ...
    result.fold(
          (error) => emit(ProductError(error as String)),
  ...
  Future<void> _onSortProducts(SortProductsEvent event, Emitter<ProductState> emit) async {
    ...
    List sorted = List<ProductModel>.from(products);
    ...
    emit(ProductLoaded(List<ProductModel>.from(sorted), sort: event.sortType, categoryId: categoryId, title: title, minPrice: minPrice, maxPrice: maxPrice));
  }
